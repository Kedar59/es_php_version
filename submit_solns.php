...
<html lang="en">
  ...
  <body>
    <section class="container">
      <h1 id="title">Submit Solution Form</h1>
      <form method="post" class="form" action="submit_solns.php">
        <div class="input-box">
        ...
        <div class="column">
          <div class="input-box">
            <label>Problem name or link</label>
